...
const ArcSingle = ({context,labels,thickness,displayText,innerRadius,width,height,arcIndex,hoveredIndex,setHoveredIndex, avgDeg, redDeg,currentDeg, value,clicked}) => {
